...
namespace StudentManagementProj.Controllers
{
    public class RegistrationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,firstName,lastName,NRC,course_id,batch_id,tel")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,firstName,lastName,NRC,course_id,batch_id,tel")] registration registration)
        {
            if (ModelState.IsValid)
            {
